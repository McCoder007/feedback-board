...
import { 
  ...
  serverTimestamp,
  where 
} from 'https://cdnjs.cloudflare.com/ajax/libs/firebase/9.22.1/firebase-firestore.js';
import { 
  getAuth, 
  ...
  onAuthStateChanged,
  signOut 
} from 'https://cdnjs.cloudflare.com/ajax/libs/firebase/9.22.1/firebase-auth.js';
